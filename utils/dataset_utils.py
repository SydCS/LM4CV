...
def get_labels(dataset):
    if dataset == "cub":
        ...
        train_test_split = pd.read_csv(
            os.path.join("./data/", "CUB_200_2011", "train_test_split.txt"),
            sep=" ",
...
def get_image_dataloader(dataset, preprocess, preprocess_eval=None, shuffle=False):
    ...
    if dataset == "cub":
        ...
        trainset = torchvision.datasets.ImageNet(
            root="./data/Imagenet", split="train", transform=preprocess
        )
        testset = torchvision.datasets.ImageNet(
            root="./data/Imagenet", split="val", transform=preprocess
        )
        ...
        trainset = torchvision.datasets.OxfordIIITPet(
            root="./data/", split="trainval", transform=preprocess, download=True
        )
        testset = torchvision.datasets.OxfordIIITPet(
            root="./data/", split="test", transform=preprocess, download=True
        )
...
def get_attributes(cfg):
    ...
    if cfg["attributes"] == "random":
        ...
        return (
            open("./data/CUB_200_2011/cub_attributes.txt", "r")
            .read()
            .strip()
            .split("\n")
        )
        ...
        return (
            open("./data/flowers-102/flower_attributes.txt", "r")
            .read()
            .strip()
            .split("\n")
        )
        ...
        return (
            open("./data/food-101/food_attributes.txt", "r").read().strip().split("\n")
        )

    elif cfg["attributes"] == "cars":
        return (
            open("./data/stanford_cars/cars_attributes.txt", "r")
            .read()
            .strip()
            .split("\n")
        )
        ...
        return (
            open("./data/Imagenet/imagenet_attributes.txt", "r")
            .read()
            .strip()
            .split("\n")
        )
        ...
        return (
            open("./data/Imagenet/imagenet_animal_attributes.txt", "r")
            .read()
            .strip()
            .split("\n")
        )
        ...
        return (
            open("./data/cifar-10-batches-py/cifar10_attributes.txt", "r")
            .read()
            .strip()
            .split("\n")
        )
        ...
        return (
            open("./data/cifar-100-python/cifar100_attributes.txt", "r")
            .read()
            .strip()
            .split("\n")
        )
        ...
        return (
            open("./data/oxford-iiit-pet/oxford_pets_attributes.txt", "r")
            .read()
            .strip()
            .split("\n")
        )
